...
from myPackage.mySubPackageA.mySubSubPackageB import LowLevelModule
...
class TestLowLevelFunction(TestCase):
    def test_function(self):
        ...
        self.assertEqual(retval, "Another Low Level Function")
...
class TestLowLevelData(TestCase):
    def test_data(self):
        ...
        self.assertEqual(LowLevelData["element2"]["subElement3"], 3)
